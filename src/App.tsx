  ...
  return (
    <>
      <div className="mt-sm-5">
        <Container>
          <Stack direction="horizontal" gap={3} className="ms-sm-4">
            <Card border="warning" className="w-25 ms-sm-5">
            ...
            <Card border="warning" className="w-25 ms-sm-5">
              ...
              <Card.Body>
                <Card.Title className="position-relative top-sm-5">Legenda Seluler</Card.Title>
              </Card.Body>
              <Card.Footer className="text-bg-warning">
            ...
            <Stack direction="horizontal" gap={3} className="mt-sm-4">
            ...
            <Card border="warning" className="w-25">
              <Card.Img variant="top" src="https://clipart-library.com/img/1223500.png" className="mt-sm-3"/>
              <Card.Body>
            ...
            <Card border="warning" className="w-25">
              ...
              <Card.Body>
                <Card.Title className="position-relative top-sm-5">Salary Calculating</Card.Title>
              </Card.Body>
              <Card.Footer className="text-bg-warning">
          ...
          <Card border="warning" className="w-25">
            ...
            <Card.Body>
              <Card.Title className="position-relative top-sm-5">Word Scrambl</Card.Title>
            </Card.Body>
            <Card.Footer className="text-bg-warning">
              <Link to="/WordScrambl">
                <Button variant="outline-dark" >
